/* This is the complete sketch with all the necessary library (local I2Cdev and MPU6050) to compile on Arduino IDE 1.8.5
   There are so many variation of MPU6050.h and IC2dev.h that do not compile.   
  You may need to install OSC and other libraries. 
  By Nava Tabkum 4/22/2018 
  ************************************************************
...
const IPAddress outIp(10,0,1,46);     // remote IP to receive OSC
